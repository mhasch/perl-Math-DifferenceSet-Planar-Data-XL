...
pds_12400.db - size XL database with planar difference set samples

=head1 VERSION

This is version 3.0 of the database, created on Jan 06, 2023.
...
It contains 12400 cyclic planar difference set planes with orders
ranging from 2 to 131449.  For all planes, std reference sets are included.
For planes with orders up to 11069, lex reference sets are included,
too.  For planes with orders up to 4297, gap reference sets are
